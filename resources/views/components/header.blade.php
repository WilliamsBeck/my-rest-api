                ...
                <div class="col-lg-12 d-none d-md-block">
                    <div class="top-logo-area">
                        <div class="logo text-md-center">
                            <a href="{{ route('home') }}"><img src="{{ asset('assets/images/wilbake/logowilbake.png') }}" alt="logo" style="width:40%"></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-3 col-lg-3 col-6">
                    <div class="header-right-items content_hidden d-none d-md-block">
                        <span class="phone-number font-lg-p" title="Call us for fast delivery">
                            <a href="#cfd"><i class="icon-telephone"></i>&nbsp;&nbsp;
                                <small class="text-color-primary">
                                    <b>Fast Delivery 88719</b>
                                </small>
                            </a>
                        </span>
                </div>
                    ...
                    <div class="header_navigation d-none d-lg-block">
                        <nav class="navigation-menu">
                            <ul class="justify-content-center">
                                <li>
                                    <a href="{{ route('home') }}"><span>Home</span><img src="{{ asset('assets/images/wilbake/ikonwilbake.png') }}" alt="" class="ikon-nav"></a>
                                </li>
                                <li>
                                    <a href="{{ route('plp') }}"><span>Shop</span><img src="{{ asset('assets/images/wilbake/ikonwilbake.png') }}" alt="" class="ikon-nav"></a>
                                </li>
                                <li>
                                    <a href="{{ route('contact') }}"><span>Contact Us</span><img src="{{ asset('assets/images/wilbake/ikonwilbake.png') }}" alt="" class="ikon-nav"></a>
                                </li>
                            </ul>
                        </nav>
                    </div>
